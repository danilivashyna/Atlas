...
> **📖 Полный гайд по v0.2**: См. [docs/v0.2_quickstart.md](docs/v0.2_quickstart.md) для подробной документации и примеров.  
> **🎓 Демонстрации**: См. [demos/](demos/) для интерактивных примеров без тяжёлых зависимостей.
...
| [docs/v0.2_quickstart.md](docs/v0.2_quickstart.md) | **v0.2 Quick Start Guide** - быстрый старт (NEW!) |
...
| Документ | Описание |
|----------|----------|
| [demos/demo_01_basic.md](demos/demo_01_basic.md) | Базовое использование Atlas (без тяжёлых зависимостей) |
| [demos/demo_02_hierarchical.md](demos/demo_02_hierarchical.md) | Иерархическое пространство v0.2 (NEW!) |
| [demos/demo_03_cli.md](demos/demo_03_cli.md) | Примеры использования CLI (NEW!) |
