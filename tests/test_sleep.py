...
class TestSleepManager:
    ...
    def test_consolidation_dry_run(self, sleep_manager: SleepManager) -> None:
        ...
        result = sleep_manager.run_consolidation(
            run_id="test-dry-001", dry_run=True
        )
    ...
    def test_consolidation_full_run(
        ...
        result = sleep_manager.run_consolidation(
            run_id="test-full-001", dry_run=False
        )
    ...
    def test_defragmentation_below_threshold(
    ...
    def test_threshold_recalibration_dry_run(
        self, sleep_manager: SleepManager
    ) -> None:
    ...
    def test_skip_threshold_recalibration(
        self, sleep_manager: SleepManager
    ) -> None:
    ...
    def test_consolidation_without_dependencies(
        self, temp_dir: Path
    ) -> None:
