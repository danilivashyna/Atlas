...
def test_zspace_slice_validation_valid():
    ...
    z_slice: ZSliceLite = {
        ...
        "edges": [{"src": "n1", "dst": "n2", "weight": 0.7}],
        "quotas": {"tokens": 8000, "nodes": 64, "edges": 128, "time_ms": 500},
        "seed": "valid-test",
        "zv": "v0.1.0",
    }
...
def test_zspace_slice_validation_edge_unknown_node():
    ...
    z_slice: ZSliceLite = {
        ...
        "edges": [{"src": "n1", "dst": "n_unknown", "weight": 0.5}],  # Unknown dst
        "quotas": {"tokens": 8000, "nodes": 64, "edges": 128, "time_ms": 500},
...
def test_vec_mmr_improves_diversity_over_score_sort():
    ...
    assert any(
        node_id.startswith("b") for node_id in ids
    ), "Should have cluster B nodes (diversity)"
