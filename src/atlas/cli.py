...
Examples:
  ...
  atlas info
    ...
    # Transform command
    parser_transform = subparsers.add_parser('transform', help='Transform text through semantic space')
    ...
    parser_manipulate.add_argument('--dimension', '-d', type=int, required=True, 
                                   choices=[0, 1, 2, 3, 4], help='Dimension to change (0-4)')
    parser_manipulate.add_argument('--value', '-v', type=float, required=True, 
                                   help='New value (-1 to 1)')
    ...
    parser_explore.add_argument('--dimension', '-d', type=int, required=True,
                               choices=[0, 1, 2, 3, 4], help='Dimension to explore (0-4)')
    ...
    parser_encode_h.add_argument('--max-depth', type=int, default=1, choices=[0, 1, 2, 3, 4, 5],
                                 help='Maximum tree depth (default: 1)')
    parser_encode_h.add_argument('--expand-threshold', type=float, default=0.2,
    ...
    parser_decode_h.add_argument('--top-k', type=int, default=3, help='Number of top paths (default: 3)')
    ...
    parser_manipulate_h.add_argument('--edit', action='append', required=True,
