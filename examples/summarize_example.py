...
def main():
    ...
    result = summarize(
        text=long_text.strip(), target_tokens=60, mode="compress", epsilon=0.05, preserve_order=True
    )
    ...
    result = summarize(
        text=short_text, target_tokens=50, mode="expand", epsilon=0.1, preserve_order=True
    )
